 ...
 */
final class PhpErrorController {
     ...
     */
    public function __invoke(RequestInterface $request, ResponseInterface $response, \Throwable $error) : ResponseInterface {
        $response->getBody()
            ->write("<h1>500 Internal Server Error</h1><h3>PHP</h3><p>An error has occurred processing the request.</p>");
